...
class _Home2State
    extends State<Home2> with TickerProviderStateMixin {
  int currentValue = 0;
              ...
              child: Row(
                ...
                children: [
                  IconButton(
                    icon: Icon(
                      Icons.home,
                      color: currentValue == 0 ? Colors.black : Colors.black38,
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      color: currentValue == 1 ? Colors.black : Colors.black38,
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      color: currentValue == 3 ? Colors.black : Colors.black38,
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      color: currentValue == 4 ? Colors.black : Colors.black38,
